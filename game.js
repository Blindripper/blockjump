...
class Game {
    constructor() {
        ...
        this.collisionTolerance = 0.005; // Adjust this value to fine-tune collision detection
        this.keys = {};
    ...
    checkPreciseCollision(player, enemy) {
        const playerHitbox = {
            x: player.x + player.width * 0.05,
            y: player.y + player.height * 0.05,
            width: player.width * 0.003,
            height: player.height * 0.003
        };

        const enemyHitbox = {
            x: enemy.x + enemy.width * 0.05,
            y: enemy.y + enemy.height * 0.05,
            width: enemy.width * 0.003,
            height: enemy.height * 0.003
        };
